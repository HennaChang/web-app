...
/**
 * A MyBatis Generator plugin to use Lombok's annotations. For example, use @Data annotation instead
 * of getter ands setter.
 *
...
public class LombokPlugin extends PluginAdapter {
     ...
     * @param introspectedColumn The class containing information about the column related to this field
     *        as introspected from the database
     * @param introspectedTable The class containing information about the table as introspected from
     *        the database
